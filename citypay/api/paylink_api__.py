...
class PaylinkApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __token_adjustment_request(
            self,
            token,
        ...
        self.token_adjustment_request = _Endpoint(
            settings={
            ...
            callable=__token_adjustment_request
        )

        def __token_close_request(
            self,
            token,
            **kwargs
        ):
        ...
        self.token_close_request = _Endpoint(
            settings={
                'response_type': (Acknowledgement,),
                'auth': [
                    'cp-api-key'
            ...
            api_client=api_client,
            callable=__token_close_request
        )

        def __token_create_bill_payment_request(
            self,
        ...
        self.token_create_bill_payment_request = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__token_create_bill_payment_request
        )

        def __token_create_request(
            self,
        ...
        self.token_create_request = _Endpoint(
            settings={
                'response_type': (PaylinkTokenCreated,),
                'auth': [
                    'cp-api-key'
            ...
            api_client=api_client,
            callable=__token_create_request
        )

        def __token_reconciled_request(
            self,
            token,
            **kwargs
        ):
        ...
        self.token_reconciled_request = _Endpoint(
            settings={
                'response_type': (Acknowledgement,),
                'auth': [
                    'cp-api-key'
            ...
            api_client=api_client,
            callable=__token_reconciled_request
        )

        def __token_reopen_request(
            self,
            token,
            **kwargs
        ):
        ...
        self.token_reopen_request = _Endpoint(
            settings={
                'response_type': (Acknowledgement,),
                'auth': [
                    'cp-api-key'
            ...
            api_client=api_client,
            callable=__token_reopen_request
        )

        def __token_status_changes_request(
            self,
        ...
        self.token_status_changes_request = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__token_status_changes_request
        )

        def __token_status_request(
            self,
            token,
            **kwargs
        ):
        ...
        self.token_status_request = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__token_status_request
        )

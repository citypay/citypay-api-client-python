...
class OperationalFunctionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __domain_key_check_request(
            self,
        ...
        self.domain_key_check_request = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__domain_key_check_request
        )

        def __domain_key_gen_request(
            self,
            domain_key_request,
            **kwargs
        ):
        ...
        self.domain_key_gen_request = _Endpoint(
            settings={
                'response_type': (DomainKeyResponse,),
                'auth': [
                    'cp-api-key'
            ...
            api_client=api_client,
            callable=__domain_key_gen_request
        )

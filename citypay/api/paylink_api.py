...
class PaylinkApi:
    ...
    def token_close_request(
        ...
        _param = self._token_close_request_serialize(
            token=token,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def token_close_request_with_http_info(
        self,
        token: Annotated[StrictStr, Field(description="The token returned by the create token process.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def token_close_request_without_preload_content(
        self,
        token: Annotated[StrictStr, Field(description="The token returned by the create token process.")],
        _request_timeout: Union[
            None,
    ...
    def _token_close_request_serialize(
        self,
        token,
        _request_auth,
        _content_type,

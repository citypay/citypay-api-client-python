...
class PaylinkTokenStatusChangeRequest(BaseModel):
    ...
    max_results: Optional[StrictInt] = Field(default=None, description="the maximum number of results between 5 and 250 to return. Default is 50.", alias="maxResults")
    merchantid: StrictInt = Field(description="the merchant id to review tokens for.")
    next_token: Optional[StrictStr] = Field(default=None, description="the next token value when more results are available.", alias="nextToken")
    order_by: Optional[List[StrictStr]] = Field(default=None, alias="orderBy")

...
class ContactDetails(object):
    ...
    def address1(self, address1):
        ...
        if (self.local_vars_configuration.client_side_validation and
                address1 is not None and len(address1) > 40):
            raise ValueError("Invalid value for `address1`, length must be less than or equal to `40`")  # noqa: E501
    ...
    def address3(self, address3):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                address3 is not None and len(address3) > 20):
            raise ValueError("Invalid value for `address3`, length must be less than or equal to `20`")  # noqa: E501
    ...
    def area(self, area):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                area is not None and len(area) > 20):
            raise ValueError("Invalid value for `area`, length must be less than or equal to `20`")  # noqa: E501

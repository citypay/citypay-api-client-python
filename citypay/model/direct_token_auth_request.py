...
class DirectTokenAuthRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nonce", "redirect_failure", "redirect_success", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nonce", "redirect_failure", "redirect_success", "token", ], str]):

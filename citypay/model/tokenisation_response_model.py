...
class TokenisationResponseModel(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sig_id"]) -> MetaOapg.properties.sig_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["authen_result", "bin_commercial", "bin_debit", "bin_description", "eci", "identifier", "maskedpan", "scheme", "sig_id", "token", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sig_id"]) -> typing.Union[MetaOapg.properties.sig_id, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["authen_result", "bin_commercial", "bin_debit", "bin_description", "eci", "identifier", "maskedpan", "scheme", "sig_id", "token", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        sig_id: typing.Union[MetaOapg.properties.sig_id, str, schemas.Unset] = schemas.unset,

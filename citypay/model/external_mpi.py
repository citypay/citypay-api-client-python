...
class ExternalMPI(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["authen_result", "cavv", "eci", "enrolled", "xid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["authen_result", "cavv", "eci", "enrolled", "xid", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        eci: typing.Union[MetaOapg.properties.eci, decimal.Decimal, int, schemas.Unset] = schemas.unset,

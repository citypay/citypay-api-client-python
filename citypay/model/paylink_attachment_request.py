...
class PaylinkAttachmentRequest(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["retention"]) -> MetaOapg.properties.retention: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["filename", "mime_type", "data", "name", "retention", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["retention"]) -> typing.Union[MetaOapg.properties.retention, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["filename", "mime_type", "data", "name", "retention", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        retention: typing.Union[MetaOapg.properties.retention, decimal.Decimal, int, schemas.Unset] = schemas.unset,

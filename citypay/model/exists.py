...
class Exists(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["exists", "active", "last_modified", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["exists", "active", "last_modified", ], str]):

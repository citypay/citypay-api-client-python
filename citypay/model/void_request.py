...
class VoidRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["merchantid", "identifier", "transno", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["merchantid", "identifier", "transno", ], str]):

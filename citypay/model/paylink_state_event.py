...
class PaylinkStateEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["datetime", "message", "state", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["datetime", "message", "state", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        state: typing.Union[MetaOapg.properties.state, str, datetime, schemas.Unset] = schemas.unset,

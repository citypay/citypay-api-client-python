...
class PaylinkAdjustmentRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "identifier", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "identifier", "reason", ], str]):

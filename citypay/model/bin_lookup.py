...
class BinLookup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bin", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bin", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        bin: typing.Union[MetaOapg.properties.bin, decimal.Decimal, int, ],

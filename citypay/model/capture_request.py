...
class CaptureRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["merchantid", "airline_data", "amount", "event_management", "identifier", "transno", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["merchantid", "airline_data", "amount", "event_management", "identifier", "transno", ], str]):

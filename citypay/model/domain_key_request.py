...
class DomainKeyRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain", "merchantid", "live", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domain", "merchantid", "live", ], str]):

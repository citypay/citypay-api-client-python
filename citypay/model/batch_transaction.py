...
class BatchTransaction(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_id", "amount", "identifier", "merchantid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_id", "amount", "identifier", "merchantid", ], str]):

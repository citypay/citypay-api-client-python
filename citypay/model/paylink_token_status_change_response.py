...
class PaylinkTokenStatusChangeResponse(
        ...
        class properties:
            ...
            class tokens(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PaylinkTokenStatus']:
                        return PaylinkTokenStatus
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PaylinkTokenStatus'], typing.List['PaylinkTokenStatus']],
                ...
                def __getitem__(self, i: int) -> 'PaylinkTokenStatus':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tokens", "nextToken", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tokens", "nextToken", ], str]):

...
class CardStatus(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["card_status", "default", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["card_status", "default", ], str]):

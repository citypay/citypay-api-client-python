...
class BatchReportRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["batch_id", "client_account_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["batch_id", "client_account_id", ], str]):

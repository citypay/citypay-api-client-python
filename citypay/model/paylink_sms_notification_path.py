...
class PaylinkSMSNotificationPath(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["to", "template", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["to", "template", ], str]):
